...
def openTrade():
    ...
    if item != "":
        ...
        if item == "EUR/USD":
                ...
                #line 
                fig1 = plt.Figure(figsize=(5,4),dpi=90)
...
#frame2: tab view, radio button, button, result(label frame), plot
...
"""
EUR/USD and EUR/GBR --> used same csv file "eurusd.csv" 
"""